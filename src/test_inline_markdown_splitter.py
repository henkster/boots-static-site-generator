...
class TestSplitter(unittest.TestCase):
    ...
    def test_non_text_should_remain(self):
        node = TextNode("This is text with a **bold** word", TextType.BOLD)
        new_nodes = split_nodes_delimiter([node], "**", TextType.BOLD)
        self.assertEqual(len(new_nodes), 1)
    def test_unclosed_delimiter_should_raise_error(self):
        node = TextNode("This is text with an **unclosed workd", TextType.TEXT)
